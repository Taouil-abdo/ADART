<x-layouts.app>
            ...
            <div class="mt-3 text-center">
                ...
                <form id="addCategoryForm" class="mt-4">
                    ...
                    <textarea name="description" placeholder="Category Description"
                        class="w-full px-3 py-2 border rounded-md mb-3" rows="3"></textarea>
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <form id="editCategoryForm" class="mt-4">
                    ...
                    <input type="text" name="name" id="editCategoryName" placeholder="Category Name"
                        class="w-full px-3 py-2 border rounded-md mb-3" required>
                    <textarea name="description" id="editCategoryDescription" placeholder="Category Description"
                        class="w-full px-3 py-2 border rounded-md mb-3" rows="3"></textarea>
                    <div class="flex justify-between mt-4">
    ...
    <script>
        ...
        document.getElementById('addCategoryForm').addEventListener('submit', function(e) {
            ...
            // You would typically use AJAX or submit the form to a Laravel route
        });
